...
#test_op_conv_hip(Z_shape=(2, 3, 384,384), W_shape=(768,3,16,16), stride=16, padding=0, backward=False, device=device)
#test_op_batchnorm2d_hip(X_shape=(20, 768, 32, 32), channel=768, device=device)
test_op_conv_bn_relu_hip(Z_shape=(2, 3, 32,32), W_shape=(16,3,4,4), out_channels=16, stride=2, padding=0, backward=False, device=device)
# params = (32, 8, 16, 3, 2)
