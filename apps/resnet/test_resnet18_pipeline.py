...
# ------------------------------------------------------
# 1. Load torchvision ResNet18 + preprocess + label map
# ------------------------------------------------------
def load_torch_resnet18():
...
# ------------------------------------------------------
# 2. Convert ResNet18 to Needle
# ------------------------------------------------------
def convert_resnet18_to_needle(torch_model, device, dtype):
...
if __name__ == "__main__":
    print("\n===== Step 1: Load PyTorch ResNet18 =====")
    torch_model, preprocess, categories = load_torch_resnet18()

    print("\n===== Step 2: Convert to Needle =====")
    device = ndl.hip()
    dtype = "float32"

    needle_model = convert_resnet18_to_needle(
